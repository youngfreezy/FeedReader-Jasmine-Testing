...
$(function() {
    ...
    describe('The menu', function() {
         ...
         */
        it('menu element default is hidden', function() {
        ...
        it('visibility changes when menu icon clicked', function() {
            expect(body.hasClass('menu-hidden')).toBeTruthy();
    ...
    describe('Initial Entries', function() {
        ...
        it('loadFeed asynchronous works', function(done) {
